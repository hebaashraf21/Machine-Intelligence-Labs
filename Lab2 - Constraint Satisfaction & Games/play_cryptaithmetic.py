...
def main(args: argparse.Namespace):
    ...
    problem = CryptArithmeticProblem.from_file(args.puzzle)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Play CryptArithmetic as Human or AI")
